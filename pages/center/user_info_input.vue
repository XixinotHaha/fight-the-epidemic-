<template>
	<view class="grace-body">
		<view class="grace-form grace-margin-top">
			...
			<view class="cu-list">
				<view class="cu-item ">
					<view class="content" style="display: flex;justify-content: space-between;">
						...
						<input type="text" class="input"  maxlength="12" name="name" v-model="user.username"
				...
				<view class="cu-item ">
					<view class="content" style="display: flex;justify-content: space-between;">
						...
						<input type="text" class="input"  name="mobile" v-model="user.mobile" :placeholder="data.mobile"
			...
			<view class="btn" @click="formSubmit">{{data.next}}</view>
		</view>
	...
	export default {
		...
		data() {
			...
			return {
				...
				userImage: '/static/center/morenavatar.png',
				page_type: "",
				sexIndex: 0,
				user: {
					username:"",
			...
			upload() {
				uni.chooseImage({
					...
					success(res) {
						...
						uni.navigateTo({
							url: '/pages/center/upload_input?src=' + src
						});
					}
				});
			},
